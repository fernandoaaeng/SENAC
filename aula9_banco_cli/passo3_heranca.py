# Aula 9 — Passo 3: Herança
# Ideia: ContaPoupanca e ContaCorrente reaproveitam Conta e especializam o comportamento.
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        # Saldo pode ficar negativo até -limite (ex.: saldo 100, limite 200 -> até -200).
...
# --- Demonstração ---
print("=== Passo 3: herança ===")

poupanca = ContaPoupanca("Ana", 1000.00, 0.01)
corrente = ContaCorrente("Bruno", 100.00, 200.00)

print("\nPoupança (antes do rendimento):")
poupanca.exibir()
poupanca.render()

print("\nCorrente (saldo 100, limite 200):")
corrente.exibir()
print("Saque de 250 — numa Conta comum falharia; aqui o limite permite:")
corrente.sacar(250.00)
corrente.exibir()
