# Aula 9 — Passo 4: Polimorfismo
# Ideia: tratamos objetos diferentes (poupança e corrente) como Conta.
...
# (if isinstance...). Cada objeto responde com o método da sua classe;
# aqui todos herdam o mesmo exibir() de Conta.
